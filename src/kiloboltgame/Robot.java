...
public class Robot {
	...
	// Constants are Here
	public static final int JUMPSPEED = -20;
	...
	public void update() {
		...
		rect.setRect(centerX - 34, centerY - 63, 68, 43);
		rect2.setRect(rect.getX() , rect.getY() + 63, 68, 63);
		rect3.setRect(rect.getX() - 16, rect.getY() + 32, 26, 20);
		rect4.setRect(rect.getX() + 48, rect.getY() + 32, 26, 20);
	...
	public void shoot() {
		Projectile p = new Projectile(centerX + 25, centerY);
		projectiles.add(p);
	}
